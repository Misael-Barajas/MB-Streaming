...
window.products = [
    ...
    { id: 110, name: "YouTube Premium", category: "streaming", price: "Desde $90 hasta $220 MXN",
      description: "Videos sin anuncios + descargas y YouTube Music. Ideal si consumes mucho YouTube.",
      features: ["Cuenta nueva (no renovable)", "Descargas sin conexión", "YouTube Music incluido", "Compatible con combo", "Garantía y soporte"],
      image: LOGOS.youtube, color: COLORS.youtube,
      variants: [{ label: "1 Mes", price: "$90 MXN" }, { label: "2 Meses", price: "$150 MXN" }, { label: "3 Meses", price: "$220 MXN" }] },
    ...
    { id: 303, name: "ChatGPT", category: "tool", price: "Desde $80 hasta $120 MXN",
      ...
      variants: [{ label: "Go", price: "$80 MXN" }, { label: "Plus", price: "$120 MXN" }]},

    { id: 305, name: "Gemini", category: "tool", price: "$150 MXN",
      description: "IA de Google con acceso a funciones avanzadas e integración con servicios Google.",
      features: ["Gemini Advanced", "Google AI Pro", "Compatible con combo", "Garantía y soporte"],
    ...
    { id: 530, name: "Combos con Prime", category: "duo", price: "$125 MXN",
      ...
      image: LOGOS.prime, color: COLORS.prime, logoClass: "h-20 w-auto",
      variants: [
        { label: "con Crunchyroll", price: "$125 MXN" },
        { label: "con VIX", price: "$125 MXN" },
        { label: "con Paramount+", price: "$235 MXN" }
      ]},
